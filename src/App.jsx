...
const voteModule = sdk.getVoteModule(
  "0xcb4FfbD71CB3c4959F51DAf68df667BF7508A046",
);
...
useEffect(() => {
  ...
  if(!address){
    return (
      <div className="landing">
        <h1>Welcome to NFTSupportDAO 💸</h1>
  ...
  if (hasClaimedNFT) {
    ...
    return (
      ...
      <h1>Mint your free NFTSupportDAO 💸 Membership NFT</h1>
      <button
        disabled={isClaiming}
        onClick={() => mintNft()}
      >
